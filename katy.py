...
class Upload(db.Model):
    ...
    def __init__(self, data, desc, dept, classnum, year, semester): # , location): 
        self.data = data
        self.desc = desc 
        self.dept = dept
...
def new():
    ...
    if request.method == 'POST':
        ...
        if filekt.filename == '':
            ...
            upload = Upload(filename, desc, dept, classnum, year, semester) #,location)
...
def download(filename):
    ...
    return send_from_directory(directory=syllabikit, filename=filename)
